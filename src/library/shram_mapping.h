...
#define SHRAM_OFFSET_LENFIFO_COUNT          100     // monotonic message counter (4 bytes, aligned)
#define SHRAM_OFFSET_LENFIFO_RING           104     // ring base
#define LENFIFO_DEPTH                        2048    // ring depth (power of two, entries)
#define LENFIFO_ENTRY_BYTES                  2       // bytes/entry (message length; see map comment above)
